...
export const Sidebar = () => {
  ...
  return (
    <div className="">
      ...
      <nav className={`absolute top-0 right-0 z-20 border border-gray-700 rounded-2xl bg-bg_primary/50 backdrop-blur-md transition-all duration-300 w-2/3 max-w-100 overflow-hidden ${isOpen ? 'translate-x-0 shadow-lg shadow-gray-700' : 'translate-x-full shadow-none'}`}>
